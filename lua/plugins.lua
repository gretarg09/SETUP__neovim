...
require("lazy").setup({
    ...
    -- NVIM DAP
    {
        ...
        config = function()
            ...
            if ok and mason_registry.is_installed("js-debug-adapter") then
                ...
                local js_debug_path = mason_settings.current.install_root_dir .. "/packages/js-debug-adapter"
    ...
    -- OBSIDIAN
    {
        ...
        config = function()
            ...
            -- Custom obsidian keymaps for markdown buffers
            vim.api.nvim_create_autocmd("FileType", {
                pattern = "markdown",
                callback = function()
                    vim.keymap.set("n", "gf", function()
                        require("obsidian.api").follow_link()
                    end, { noremap = false, buffer = true, desc = "Obsidian follow link" })
