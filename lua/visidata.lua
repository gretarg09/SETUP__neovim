...
local function get_visual_selection()
    print('running get_visual_selection')
    print("the v position:" .. vim.inspect(vim.fn.getpos("v")))
    print("the . position:" .. vim.inspect(vim.fn.getpos(".")))
...
end, { desc = "Visualize Pandas DF with VisiData" })

print('LOADING visidata.lua')
